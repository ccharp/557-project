...
```{r}
# setup
log_ghg_capita = log10(ghg_country_2018_df$`Total greenhouse gas emissions per capita (kt of CO2 equivalent per person)`)
log_ghg_tot = log10(ghg_country_2018_df$`Total greenhouse gas emissions (kt of CO2 equivalent)`)
log_ghg_pct = log10(ghg_country_2018_df$`Total greenhouse gas emissions as % of Total (kt of CO2 equivalent)`)
...
analyze_model = function(model) {
  ...
  rdf = nrow(ghg_country_2018_df) - nrow(result) + 1
